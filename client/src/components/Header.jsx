...
const Header = () => {
  return (
    ...
    viewport={{ once: true }}
    >
      <motion.div className='text-stone-500 inline-flex gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'
      ...
      className='flex flex-wrap justify-center gap-3 mt-16'>
        {Array(6).fill('').map((item,index) => (
          ...
          className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' key={index} 
